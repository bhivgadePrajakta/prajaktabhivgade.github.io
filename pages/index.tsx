  ...
  return (
    <div className="flex flex-col flex-grow px-6 pt-1 ">
      <h6 className="my-3 text-base font-medium">
        I am currently pursuing B.E. Degree(3rd Year) in Computer Science
        Engineering from S. B. Jain Institute of Technology. I have 2+ years of experience with c++ programming language and also I am part of great communities.
      </h6>
      <div
